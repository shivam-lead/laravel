                ...
                <div class="col-xl-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="{{ url('update-news') }}/{{$blog->id}}" enctype="multipart/form-data" method="POST">
                                @csrf
                                <div class="mb-3">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-4">
                                        ...
                                        <input type="text" class="form-control" value="{{$blog->meta_description}}" name="meta_descripition"
