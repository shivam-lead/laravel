@extends('layouts.app')
 ...
 <title>News | Optimyze Finance </title>
@endsection
@section('content')
                        ...
                        <div class="col-sm-6 col-12">
                            <div class="blog__item">
                                <div class="blog__thumb">
                                    <a href="{{$blog->id}}"><img src="{{$blog->image}}" alt="rajib raj"></a>
                                </div>
                                <div class="blog__content">
                                    ...
                                    <h5><a href="{{$blog->id}}">{{$blog->title}}</a></h5>
                                </div>
                            </div>
                        </div>
                        @endforeach
                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-12">
                                <div class="sidebar__recentpost">
                                    ...
                                    <div class="body">
                                        <ul>
                                            @foreach($news as $blogg)
                                           
                                            <li>
                                                <div class="thumb">
                                                    <a href="{{$blogg->id}}"><img src="{{$blogg->image}}" alt="rajib raj"></a>
                                                </div>
                                                <div class="content">
                                                    <h6><a href="{{$blogg->id}}">{{$blogg->title}}</a></h6>
